...
export default function Footer() {
  return (
    <div className="relative h-full w-full p-2 flex flex-col bg-[#17111A] overflow-hidden">
      <div className="h-full w-full p-8 flex flex-col gap-8 md:grid  md:grid-cols-2">
      ...
      <div className="h-full w-full p-4 md:pt-16 flex justify-start items-center gap-4">
        ...
        <span className="p-1 bg-black rounded-lg">
          <a href="">
            <XIcon size={24} color="white" />
          </a>
        </span>
        <span className="p-1 bg-blue-700 rounded-lg">
          <a href="">
